# app.py
# MemeGen Pro — Streamlit Meme Generator (Minimal & Professional UI)
...
st.markdown("<h1 style='text-align:center; color:#333333;'>MemeGen Pro</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align:center; color:#555555;'>Create topic-aware memes with OpenRouter AI in a classic white strap style. Minimal & professional interface.</p>", unsafe_allow_html=True)
